...
| `activeTrigger`    | Extra classes on the trigger while `isActive` |
...
| `triggerText`           | `string`                                                                     | -                    | Fixed text on the trigger, replacing the value, the chips and the placeholder |
