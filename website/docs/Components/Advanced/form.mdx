...
Keys: `input`, `selector`, `autocomplete`, `number`, `inputsGroup`. Each accepts every prop of the matching
primitive except the ones the form drives itself (`value`, `onValueChange`, `error`, `label`, `isDisabled`,
